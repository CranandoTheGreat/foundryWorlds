import { AnimationSubSettings } from "./animations.js";
import { updateAnimation, updateTimer } from "./api.js";
import { CombatReady } from "./combatReady.js";
import { TimerSubSettings } from "./timers.js";
...
export const registerSettings = () => {
    ...
    getGame().settings.register(MODULE_NAME, "selectedAnimation", {
        scope: "world",
        config: false,
        type: String,
        default: "native",
    ...
    getGame().settings.registerMenu(MODULE_NAME, "animationSettings", {
    ...
    getGame().settings.register(MODULE_NAME, "pantotoken", {
